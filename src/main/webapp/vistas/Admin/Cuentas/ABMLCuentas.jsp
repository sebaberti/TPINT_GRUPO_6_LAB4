...
<main class="container py-4">
    ...
    <div class="col">
        <div class="card text-center card-abml h-100">
            <div class="card-body d-flex flex-column justify-content-between">
                <div>
                    <div class="icono text-success"><i class="bi bi-plus-circle"></i></div>
                    <h6 class="card-title mb-2">Alta de Cuenta</h6>
                </div>
                <button class="btn btn-success btn-sm w-100 btn-abml" onclick="location.href='CrearCuenta.jsp'">Seleccionar</button>
            </div>
        </div>
    </div>
    ...
    <div class="col">
        <div class="card text-center card-abml h-100">
            <div class="card-body d-flex flex-column justify-content-between">
                <div>
                    <div class="icono text-primary"><i class="bi bi-list-ul"></i></div>
                    <h6 class="card-title mb-2">Listar y editar Cuentas</h6>
                </div>
                <a href="ListarCuentas.jsp" class="btn btn-primary btn-sm w-100 btn-abml">Seleccionar</a>
            </div>
        </div>
    </div>
</div>
