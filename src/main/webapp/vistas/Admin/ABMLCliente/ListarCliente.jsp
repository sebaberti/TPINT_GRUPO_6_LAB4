...
<main class="container mt-5 mb-5">
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <form method="POST" action="${pageContext.request.contextPath}/ListarClientesServlet">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="cuilCliente" class="form-label">CUIL del Cliente</label>
                    <input type="text" class="form-control shadow-sm" id="cuilCliente"
                           name="txtCuilClientes" placeholder="Ingrese CUIL (o deje vacío)">
                </div>

                <small class="text-muted">Ingrese <strong>solo uno</strong> de los campos para buscar.</small>
    ...
    <div class="table-responsive mt-5">
        <table id="tabla_clientes" class="table table-bordered table-hover align-middle text-center">
            ...
            %>
                <tr>
                    <td colspan="7">No se encontraron clientes para mostrar.</td>
                </tr>
            <%
                }
            %>
